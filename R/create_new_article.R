...
#' @param series string of the series, Default: 'series'
...
#' @return By default the yaml boilerplate to the command line. If a file path is included it will create that file.
#' @details DETAILS
#' @examples
#' \dontrun{
#' if(interactive()){
